/*
 * Escriba un metodo, de nombre cambioMonedas,
 * que reciba como parametro un valor real que indica una
 * cantidad de dinero en euros. El metodo imprime por
 * pantalla la cantidad de monedas de cada tipo en que se
...
public class CambioMonedas{
   ...
   System.out.println("Introduzca el cambio a devolver en centimos de euro: ");
