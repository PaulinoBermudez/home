...
public class ControladorAlumnos implements ActionListener, KeyListener {
    ...
    public void LLenarTabla(JTable tablaD) {
        ...
        ArrayList<Alumno> listaAlumno = alumnoDao.listarAlumno();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vistaAlumnos.getBtnRegistrar()) {
            ...
            String rptaRegistro = alumnoDao.agregarAlumno(dni, nombre, apellidos, fecha, direccion);
        ...
        if (e.getSource() == vistaAlumnos.getBtnOKEditar()) {
            ...
            int rptEdit = alumnoDao.editarAlumno(dni, nombre, apellidos, fecha, direccion);
            if (rptEdit > 0) {
                LimpiarCampos();
