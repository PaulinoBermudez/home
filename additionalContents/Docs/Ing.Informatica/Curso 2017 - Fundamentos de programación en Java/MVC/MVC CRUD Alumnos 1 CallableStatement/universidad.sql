...
--
-- Servidor: localhost
-- Tiempo de generación: 20-06-2017 a las 05:38:16
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualizarAlumno`(IN `pdni` CHAR(8), IN `pnombre` VARCHAR(45), IN `papellidos` VARCHAR(45), IN `pfechaN` DATE, IN `pdireccion` VARCHAR(45))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_eliminarAlumno`(IN `pdni` CHAR(8))
BEGIN
...
('23345', 'marc', 'rivero', '2017-06-10', 'eeee'),
('6547', 'manolo', 'valen', '2017-06-01', 'zdfxdf');
