...
public class PanelDatosCoche extends JPanel {
    ...
    public PanelDatosCoche() {
        ...
        JLabel matricula = new JLabel("Matrícula: ", JLabel.RIGHT);
        ...
        JLabel anno = new JLabel("Año de fabricación ", JLabel.RIGHT);
        MaskFormatter formato = null;
        try {
            formato = new MaskFormatter("####");
        } catch (ParseException e) {
            //se captura la excepcion y no se hace nada
        }
    ...
    public JCheckBox getEsMetalizada() {
        return esMetalizada;
    }
    ...
    public JComboBox getTipoCoche() {
        return tipoCoche;
    }

    public JFormattedTextField getCampoanno() {
        return campoanno;
    }

    public JRadioButton getTodoRiesgo() {
        return todoRiesgo;
    }

    public JRadioButton getTerceros() {
        return terceros;
    }  
}
