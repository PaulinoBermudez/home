...
public class Menu {
    ...
    private final BorderLayoutModelo border = new BorderLayoutModelo();
    private final BoxLayoutModelo box = new BoxLayoutModelo();
    private final FlowLayoutModelo flow = new FlowLayoutModelo();
    private final GridLayoutModelo grid = new GridLayoutModelo();
        ...
        do {
            ...
            switch (opcionPrincipal) {
                ...
                case 5:
                    ...
                    ControladorPrincipal cPrincipal = new ControladorPrincipal(vista);
