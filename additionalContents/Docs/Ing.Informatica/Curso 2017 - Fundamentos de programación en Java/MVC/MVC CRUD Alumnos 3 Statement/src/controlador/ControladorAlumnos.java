    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vistaAlumnos.getBtnEditar()) {
            ...
            if (filaEditar >= 0 && numfilas == 1) {
                ...
                vistaAlumnos.getTxtNombre().setText(String.valueOf(vistaAlumnos.getJtDatos().getValueAt(filaEditar, 1)));
                vistaAlumnos.getTxtApellidos().setText(String.valueOf(vistaAlumnos.getJtDatos().getValueAt(filaEditar, 2)));

                vistaAlumnos.getJdFechaN().setDateFormatString(String.valueOf(vistaAlumnos.getJtDatos().getValueAt(filaEditar, 3)));
                ...
                vistaAlumnos.getTxtDireccion().setText(String.valueOf(vistaAlumnos.getJtDatos().getValueAt(filaEditar, 4)));
