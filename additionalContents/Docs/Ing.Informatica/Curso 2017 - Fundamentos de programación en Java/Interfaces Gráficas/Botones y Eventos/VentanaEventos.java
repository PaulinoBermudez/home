...
public class VentanaEventos extends JFrame implements KeyListener {

    private JLabel labelTitulo;
    private JLabel labelAreaEntrada;
    private JLabel labelAreaSalida;
    private JLabel labelSalida;
    private JLabel labelContadorVocales;
    private JTextArea areaEntradaDeTexto;
    private JScrollPane scrollPaneAreaEntrada;
    private JTextArea areaSalidaDeTexto;
    private JScrollPane scrollPaneAreaSalida;
    ...
    public VentanaEventos() {
        ...
        setTitle("Ventana Eventos del Teclado");
    ...
    public void keyReleased(KeyEvent e) {
        System.out.println("Soltar la tecla:  " + e.getKeyText(e.getKeyCode()));
        if (e.getSource() == areaEntradaDeTexto) {
    ...
    /**
     * Este metodo funcionarï¿½ solo cuando se presionan caracteres, si se
     * presionan teclas como F1, F2, inicio etc no ejecutarï¿½ ningun evento
     */
    @Override
