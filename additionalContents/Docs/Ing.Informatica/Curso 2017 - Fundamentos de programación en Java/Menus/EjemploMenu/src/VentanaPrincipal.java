...
public class VentanaPrincipal extends JFrame implements ActionListener {
    ...
    private void iniciarComponentes() {
        ...
        informacionCoDejaVu += "basicos y ejemplos sencillos de programacion.\n\n";
 ...
 /*Labels*/
        ...
        menuItemAplicacion.setText("Aplicacion");
	...
	*opciones del menu, se trabajan en metodos separados por organizacion*/
        ...
        if (evento.getSource() == itemEmergente1) {
            JOptionPane.showMessageDialog(null, "Presiona la opcion emergente 1");
        }

        if (evento.getSource() == itemEmergente2) {
            JOptionPane.showMessageDialog(null, "Presion� la opcion emergente 2");
        }
