...
public class operacionesFichero {
    public static int nActivos;                     // Entero para guardar el n̼mero de activos
	...
	/*
     * M̩todo que comprueba si el string que se le pasa es un n̼mero
     */
	...
	/*
     * M̩todo que comprueba si el fichero de entrada es correcto
     */
